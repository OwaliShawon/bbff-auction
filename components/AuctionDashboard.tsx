...
export const AuctionDashboard: React.FC<AuctionDashboardProps> = ({
  players, teams, auction, role, onStartAuction, onIncreaseBid, onMatchBid, onFinalizeSale, onTieLottery, onSkipForNow
}) => {
                    ...
                    {role === UserRole.ADMIN && (
                      <div className="pt-4 space-y-4 border-2 border-blue-500 rounded-xl p-4">
                        ...
                        <div className="flex gap-2 mt-2">
                          ...
                          {auction.biddingTeamIds.length === 0 && (
                            <button
                              onClick={onSkipForNow}
                              className="bg-slate-400 hover:bg-slate-500 text-white px-2 py-1 rounded-lg text-[9px] font-bold uppercase tracking-wider transition shadow-sm whitespace-nowrap"
